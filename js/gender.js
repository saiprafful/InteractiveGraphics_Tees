...
function gender_attendance(arr) {
  ...
  var gender_attendance_per = [{
      title: "MalePresent",
      percentage: m_present_per
    },
    {
      title: "Male Absent",
      percentage: m_absent_per
    },
    {
      title: "Male Neutral",
      percentage: m_neutral_per
    },
    {
      title: "Female Present",
      percentage: f_present_per
    },
    {
      title: "Female Absent",
      percentage: f_absent_per
    },
    {
      title: "Female Neutral",
      percentage: f_neutral_per
    }
  ];

  // console.log(gender_attendance_per);
  ...
  var xScale = d3.scaleBand()
    .range([0, width])
    .domain(gender_attendance_per.map((s) => s.title))
    .padding(0.4)
  ...
  barGroups
    ...
    .on('mouseenter', function (actual, i) {
      ...
      var y = yScale(actual.percentage)
      ...
      barGroups.append('text')
        ...
        .attr('y', (a) => yScale(a.percentage) + 30)
        .attr('fill', 'white')
  ...
  barGroups
    ...
    .attr('class', 'Age')
    .attr('x', (a) => xScale(a.title) + xScale.bandwidth() / 2)
    .attr('y', (a) => yScale(a.percentage)-2.5)
    .attr('text-anchor', 'middle')
    .text((a) => `${a.percentage}`)
  ...
  svg.append('text')
    ...
    .attr('y', 40)
    .attr('text-anchor', 'middle')
    .text('Gender wise Attendance Percentage')
